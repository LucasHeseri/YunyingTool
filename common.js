...
(function () {
    ...
    reader.onload = function (e) {
      ...
      img.onload = function () {
        ...
        if (s.removeBgEnabled) {
          APP.applyBgRemoval(s.originalUploadDataUrl);
          return;
        }
  ...
  // ========================================================================
  // Background Removal (shared by all tabs)
  // ========================================================================
  APP.applyBgRemoval = function (dataUrl) {
    var s = APP.state;
    var img = new Image();
    img.onload = function () {
      ...
      var ni = new Image();
      ni.onload = function () { s.uploadedImage = ni; APP._afterBgRemoval(); };
  ...
  APP.bindSharedEvents = function () {
    ...
    d.removeBgCheck.addEventListener('change', function () {
      ...
      if (APP.state.removeBgEnabled) APP.applyBgRemoval(APP.state.originalUploadDataUrl);
